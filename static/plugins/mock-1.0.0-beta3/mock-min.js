!(function (t, e) { typeof exports === 'object' && typeof module === 'object' ? module.exports = e() : typeof define === 'function' && define.amd ? define([], e) : typeof exports === 'object' ? exports.Mock = e() : t.Mock = e() }(this, function () {
  return (function (t) { function e (r) { if (n[r]) return n[r].exports; var a = n[r] = {exports: {}, id: r, loaded: !1}; return t[r].call(a.exports, a, a.exports, e), a.loaded = !0, a.exports } var n = {}; return e.m = t, e.c = n, e.p = '', e(0) }([function (t, e, n) {
	...
	*/
    ...
    function n (t) { for (var e, n = {}, r = 0; r < t.length; r++)e = t[r], e && e.id && (n[e.id] = e); for (var a = [], o = 0; o < t.length; o++) if (e = t[o]) if (void 0 != e.pid || void 0 != e.parentId) { var u = n[e.pid] || n[e.parentId]; u && (u.children || (u.children = []), u.children.push(e)) } else a.push(e); return a } var r = {110000: '北京',
        ...
        820200: '离岛',
        990000: '海外',
        990100: '海外'}, a = (function () { var t = []; for (var e in r) { var a = e.slice(2, 6) === '0000' ? void 0 : e.slice(4, 6) == '00' ? e.slice(0, 2) + '0000' : e.slice(0, 4) + '00'; t.push({id: e, pid: a, name: r[e]}) } return n(t) }()); t.exports = a
